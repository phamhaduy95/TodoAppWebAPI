...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20221113141258_third-update")]
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.TaskEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = new Guid("c0e86673-bce3-4608-8c32-06763581e953"),
                            CreatedTime = new DateTimeOffset(new DateTime(2022, 11, 13, 21, 12, 58, 253, DateTimeKind.Unspecified).AddTicks(7923), new TimeSpan(0, 7, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("c0e86673-bce3-4608-8c32-06763581e953"),
                            CreatedTime = new DateTimeOffset(new DateTime(2022, 11, 13, 21, 12, 58, 253, DateTimeKind.Unspecified).AddTicks(7939), new TimeSpan(0, 7, 0, 0, 0)),
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "41c35264-2364-4a3b-a693-0264d5a54301",
                            Email = "guest@mail.com",
                            EmailConfirmed = true,
                            FirstName = "A ",
                            JoinDate = new DateTimeOffset(new DateTime(2022, 11, 13, 21, 12, 58, 253, DateTimeKind.Unspecified).AddTicks(7827), new TimeSpan(0, 7, 0, 0, 0)),
                            LastName = "Van Pham",
                            LockoutEnabled = false,
                            NormalizedEmail = "guest@mail.com",
                            NormalizedUserName = "Guest",
                            PasswordHash = "AQAAAAEAACcQAAAAEJK5z08a3xxjX3mBedy/h3YUrxAhSrqTVHN+xHQ9gv17rPNGErVpifEjCUUkhyag8A==",
                            PhoneNumber = "0785686004",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "11/13/2022 9:12:58 PM +07:00",
